...
<main class="itoaSheet">
   ...
   <section id="content" class="contentGrid">
      <div id="contentSidebar">
         ...
         <label class="indented2" style:display={$item.system.equipable && $item.system.isShield ? 'initial' : 'none'}>Current HP</label><input type="number" min="1" name="system.shield.hp" bind:value={$item.system.shield.hp} style:display={$item.system.equipable && $item.system.isShield ? 'initial' : 'none'} />
         <label class="indented2" style:display={$item.system.equipable && $item.system.isShield ? 'initial' : 'none'}>HP</label><input type="number" min="1" name="system.shield.hpMax" bind:value={$item.system.shield.hpMax} style:display={$item.system.equipable && $item.system.isShield ? 'initial' : 'none'} />
